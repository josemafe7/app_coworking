  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex lg:flex-col lg:justify-between overflow-hidden bg-[#0c1222]">
        ...
        <div
          className="absolute top-[25%] right-[20%] w-80 h-80 rounded-full"
          style={{
        ...
        />
        <div
          className="absolute bottom-[15%] left-[10%] w-64 h-64 rounded-full"
          style={{
        ...
        <div className="relative z-10 p-12">
          <blockquote className="space-y-4">
            <p className="text-[2rem] leading-[1.2] font-light text-white/90 tracking-tight max-w-md">
              ...
              <br />
              <span className="text-primary font-medium">de coworking.</span>
            </p>
            <p className="text-sm text-white/40 max-w-sm leading-relaxed">
              Crea tu cuenta en segundos y empieza a reservar
              espacios de trabajo adaptados a tus necesidades.
            </p>
          </blockquote>
        </div>
      </div>
